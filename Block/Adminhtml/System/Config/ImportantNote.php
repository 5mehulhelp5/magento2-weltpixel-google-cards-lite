...
namespace WeltPixel\GoogleCards\Block\Adminhtml\System\Config;
...
class ImportantNote extends \Magento\Config\Block\System\Config\Form\Field
{
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        $html = '<div class="importany-note">'
            ...
            . '<p>Head over to the Product Page and <a href="https://www.weltpixel.com/magento2-google-rich-cards-free-extension.html?quickview=pro" target="_blank">get your PRO version now!</a></p>'
            .  "</div>";
